...
<tr>
	<td>
					...
					<td align="left">
						...
						<tr>
							<td>
								...
								<tr>
									<td align="left">
										<img src="https://infiniteshoresholdings.com/assets/img/logo-1.png" alt="Logo" class="Logo" width="120">
									</td>
								</tr>
								</table>
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="640" style="width: 640px; min-width: 640px;" role="presentation" bgcolor="#383e56">
		...
		<tr>
			<td align="left" style="color:#45535C;padding:20px 40px 0 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:800;font-size:18px;-webkit-font-smoothing:antialiased;line-height:1.2;" class="table-container">
				 Hi, {{ $fullname }}
			</td>
		</tr>
		<tr>
            ...
            Welcome to Infinite Shores Holdings. You can find your account details below which will be used for transacting as a customer.
			</td>
		</tr>
		</tbody>
		</table>
		...
		<tr>
			...
			<tbody>
			<tr>
				<td bgcolor="#FFF" width="40" align="left" style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:12px;-webkit-font-smoothing:antialiased;line-height:1.4;">
				</td>
				<td bgcolor="#FFFFFF" align="left" style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:normal;font-size:12px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                    Account Number
				</td>
				<td bgcolor="#FFFFFF" align="left" style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:12px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                {{ $account_number }}
				</td>
				<td bgcolor="#FFF" width="40" align="left" style="color:#5a5a5a;padding:10px 0 10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:12px;-webkit-font-smoothing:antialiased;line-height:1.4;">
				</td>
        ...
        <td align="center" style="color:#ffffff;padding:20px 40px 0 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:normal;font-size:12px;-webkit-font-smoothing:antialiased;line-height:1.4;" class="table-container">
                © 2025 Infinite Shores Holdings. All rights reserved.
			</td>
		</tr>
		</tbody>
		</table>
